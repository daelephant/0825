...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body class="index_body">
        <div class="block clearfix" style="position: relative; height: 98px;">
            <a href="#" name="top"><img class="logo" src="\shop\Home\Public\images\logo.gif"></a>
                        ...
                        <form id="yw0" action="/shop/index.php/home/user/register" method="post">                <table cellpadding="5" cellspacing="3" style="text-align:left; width:100%; border:0;">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td align="left">
                                            <input name="Submit"class="us_Submit_reg" type="submit" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="2">&nbsp;</td>
            ...
            <div class="box_1">
                <div class="links clearfix"> 
                    ...
                    <a href="#" target="_blank" title="YONGDA 网上商店管理系统">
                        <img src="<?php echo IMG_URL; ?>yahoo.gif" alt="YONGDA 网上商店管理系统" border="0" />
                    </a>
