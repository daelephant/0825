...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body class="index_body">
        ...
        <div class="blank"></div>
        <div class="block">
            <a href="#" target="_blank" title="YONGDA"><img alt="YONGDA" src="./images/di.jpg"></a>
            <div class="blank"></div>
        </div>
        <div class="block">
            <div class="box">
        ...
        <div id="bottomNav" class="box block">
            <div class="box_1">
                <div class="links clearfix"> 
                    <a href="#" target="_blank" title="YONGDA"><img src="./images/ecmoban_link.jpg" alt="YONGDA" border="0"></a>
